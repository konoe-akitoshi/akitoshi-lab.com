...
export const items: TimelineItem[] = [
  ...
  { title: 'JAWS DAYS 2026', sub: 'NOC', date: '2026-03-01', dateEnd: '2026-03-02', tags: ['event', 'staff', 'noc', 'network'], pickup: true },
  { title: 'JANOG57', sub: 'NOC backboneチーム', date: '2026-02-05', dateEnd: '2026-02-07', tags: ['event', 'staff', 'noc', 'network'] },
  { title: 'MMA創設50周年記念パーティー', sub: '実行委員＆NOC発起人', date: '2025-10-25', tags: ['event', 'staff', 'noc', 'network'] },
  { title: 'Observability Conference Tokyo 2025', sub: 'NOC', date: '2026-10-27', tags: ['event', 'staff', 'noc', 'network'] },
  ...
  { title: 'ICTSC 2024', sub: '4th', date: '2025-03-01', dateEnd: '2025-03-02', tags: ['award', 'contest', 'network'], url: '/awards/ictsc-2024', pickup: true },
  { title: 'RobocupJuniorJapanOpen', sub: 'ロボット学会賞, デザイン賞', date: '2023-03-25', dateEnd: '2023-03-26', tags: ['award', 'contest', 'robotics'] },
  { title: 'Robocup Asia-Pacific (Junior Soccer Open)', sub: '2nd', date: '2021-11-22', dateEnd: '2021-11-28', tags: ['award', 'contest', 'robotics'], pickup: true },
  ...
  { title: 'FIRST Robotics Competition Infinite ReCharge', sub: 'Rookie Game Changer Award', date: '2021-05-20', dateEnd: '2021-05-23', tags: ['award', 'contest', 'robotics'] },
  ...
  { title: 'RoboMaster', sub: '2nd Prize', date: '2020-10-01', tags: ['award', 'contest', 'robotics'] },
  ...
  { title: '第64回日本学生科学賞', sub: '入選3等「自律走行システムの考案」', date: '2020-06-01', tags: ['award', 'contest', 'research', 'robotics'], url: '/awards/japan-student-science-prize-64th' },
