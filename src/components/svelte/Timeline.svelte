<script>
  ...
  const items = [
    ...
    { title: 'JAWS DAYS 2026', sub: 'NOC', date: '2026-03', year: '2026', tags: ['event', 'network'], pickup: true },
    { title: 'JANOG57', sub: 'NOC backboneチーム', date: '2026-02', year: '2026', tags: ['event', 'network'] },
    ...
    { title: 'ICTSC 2024', sub: '4th', date: '2025-03', year: '2025', tags: ['award', 'network'], url: '/awards/ictsc-2024', pickup: true },
    { title: 'RobocupJuniorJapanOpen', sub: 'ロボット学会賞, デザイン賞', date: '2023-03', year: '2023', tags: ['award', 'robotics'] },
    { title: 'Robocup Asia-Pacific (Junior Soccer Open)', sub: '2nd', date: '2021-11', year: '2021', tags: ['award', 'robotics'], pickup: true },
    ...
    { title: 'FIRST Robotics Competition Infinite ReCharge', sub: 'Rookie Game Changer Award', date: '2021-05', year: '2021', tags: ['award', 'robotics'] },
    { title: 'RoboCup World Wide (Junior Soccer Open)', sub: 'Best Team Description Paper Award, Individual 4th', date: '2021-04', year: '2021', tags: ['award', 'robotics'], pickup: true },
    { title: 'RobocupJuniorJapanOpen', sub: 'Open 2位', date: '2021-03', year: '2021', tags: ['award', 'robotics'] },
    { title: 'ロボカップジュニア・京滋奈ブロック大会', sub: 'Open 準優勝', date: '2021-01', year: '2021', tags: ['award', 'robotics'] },
    { title: 'RoboMaster', sub: '2nd Prize', date: '2020-10', year: '2020', tags: ['award', 'robotics'] },
    { title: 'RoboCupJunior Soccer Virtual Poster Session', sub: 'Most Popular Poster in Open', date: '2020-09', year: '2020', tags: ['award', 'robotics'] },
    { title: '第64回日本学生科学賞', sub: '入選3等「自律走行システムの考案」', date: '2020-06', year: '2020', tags: ['award', 'research', 'robotics'], url: '/awards/japan-student-science-prize-64th' },
    { title: 'ロボカップジュニア・京滋奈ブロック大会', sub: 'Open 優勝', date: '2020-01', year: '2020', tags: ['award', 'robotics'] },
    { title: '関西オープン', sub: 'Open 準優勝', date: '2019-06', year: '2019', tags: ['award', 'robotics'] },
    { title: 'BIWAKOオープン', sub: 'LightWeight 4位', date: '2018-09', year: '2018', tags: ['award', 'robotics'] },
    { title: 'せとうちオープン', sub: 'LightWeight 4位, SuperTeam 優勝', date: '2018-07', year: '2018', tags: ['award', 'robotics'] },
    { title: 'ロボカップジュニア・ジャパンオープン2018和歌山', sub: 'NIPPON League サッカー ビギナーズ 予選12位', date: '2018-04', year: '2018', tags: ['award', 'robotics'] },
    { title: 'SRC@国際ロボット展', sub: 'Classic部門 優勝', date: '2017-11', year: '2017', tags: ['award', 'robotics'] },
    { title: 'SRC13', sub: '全国予選 8位', date: '2016-06', year: '2016', tags: ['award', 'robotics'] },
    { title: '第53回自然科学観察コンクール', sub: '2等賞「オクラに見つけた水玉の正体」', date: '2012-06', year: '2012', tags: ['award', 'research'], url: '/awards/shizen-kagaku-kansatsu-concours-53rd', pickup: true },
  ];
...
<div>
  ...
  <div class="relative">
    ...
    {#each grouped as [year, yearItems], yi (year)}
      <div>
        <div class="relative flex items-center mb-3 {yi > 0 ? 'mt-1' : ''}">
          <div class="w-10 h-10 rounded-full bg-gray-900 text-white flex items-center justify-center text-xs font-bold z-10 flex-shrink-0">
            {yearItems.length}
          </div>
        ...
        {#each yearItems as item (item.title + item.date)}
          ...
          <div class="relative flex items-start ml-[19px] pl-7 pb-3" transition:slide={{ duration: 200 }}>
    ...
    <div class="relative flex items-center mt-1">
      <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center z-10 flex-shrink-0">
